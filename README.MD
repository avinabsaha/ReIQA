...
We utilized the vanilla MoCo-v2 training code with ImageNet database provided at [PyContrast](https://github.com/HobbitLong/PyContrast) to train our Content Aware Module using the default settings. 
